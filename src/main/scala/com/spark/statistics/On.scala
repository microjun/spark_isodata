...
object K_means_4_19 {
    ...
    val HADOOP_HOST: String = "input/data1.jpg"
    ...
    def main(args: Array[String]): Unit = {
        ...
        breakable(
            while (true) {
                ...
                //                                print("split success")
                //                                print(" ")
                //                                print(new_k_dist(now_index) > new_total_dist)
                //                                print(" ")
                //                                println(K < k / 2)
                //
                ...
                //                                new_k_center.remove(index2)
                //                                new_k_n.remove(index2)
                //                                new_k_dist.remove(index2)
                //
                //                                K -= 1
                //                            }
                //                        }
